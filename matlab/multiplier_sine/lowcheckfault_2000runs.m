...
file_path = 'D:\SIMRAN_GUPTA_INTERN\CSV\multiplier_sine\mc_2000runs.csv';
...
for i = 1:num_fault_files
    fault_files(i) = sprintf('D:\\SIMRAN_GUPTA_INTERN\\CSV\\multiplier_sine\\fault_check\\fault_lowcheck_c%d.csv', i);  % adjust naming scheme as per your files
end
