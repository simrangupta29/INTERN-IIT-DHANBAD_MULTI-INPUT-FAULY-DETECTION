...
close all;
clear all;
file_path = 'D:\SIMRAN_GUPTA_INTERN\CSV\buck\reduced2031_mcp_500runs.csv';  % faultfree MonteCarlo data
...
order=7;
Vin1=d{502};   % first input
Vin2=d{503};   % second input
for n = 1:500		%except 1st row 1st row is time
	y=d{n+1};                           % output of each run
    % Vin1=d{2502};   % first input
    % Vin2=d{2503};   % second input
    p= polyfitn([d{502},d{503}],y,order);  % doing polyfitn to get the polynomial regression
