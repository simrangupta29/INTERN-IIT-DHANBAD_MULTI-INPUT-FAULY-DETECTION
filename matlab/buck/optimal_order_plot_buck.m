...
% Load CSV file
file_path = 'D:\SIMRAN_GUPTA_INTERN\CSV\buck\reduced_mc_500run.csv';   
...
figure;
plot(1:15, optimal_order, 'o-', 'LineWidth', 1.5);  
...
figure;
plot(1:15, mserror, 'o-', 'LineWidth', 1.5);  
xlabel('Polynomial Order');
