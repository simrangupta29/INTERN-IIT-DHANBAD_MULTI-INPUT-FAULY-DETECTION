...
file_path = 'D:\SIMRAN_GUPTA_INTERN\CSV\buck\reduced_mc_1000run.csv';
...
for i = 1:num_fault_files
    fault_files(i) = sprintf('D:\\SIMRAN_GUPTA_INTERN\\CSV\\buck\\original\\lowfault_new\\lowfault%d.csv', i);  % adjust naming scheme as per your files
end
