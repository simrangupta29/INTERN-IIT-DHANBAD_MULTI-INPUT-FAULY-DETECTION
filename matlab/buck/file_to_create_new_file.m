...
file_path = 'D:\SIMRAN_GUPTA_INTERN\CSV\buck\Buck_mcFault_1000run.csv'; 
...
vout_cols = data(:, 2:34);        % Columns 2–1001: Vout
...
output_file_csv = 'D:\SIMRAN_GUPTA_INTERN\CSV\buck\reduced_mcFault_1000run.csv';
