...
file_path = 'D:\SIMRAN_GUPTA_INTERN\CSV\buck\reduced2031_mcp_500runs.csv';
...
for i = 1:num_fault_files
    fault_files(i) = sprintf('D:\\SIMRAN_GUPTA_INTERN\\CSV\\buck\\reduced2031_multiplefault\\reduced2031_multifault%d.csv', i);  % adjust naming scheme as per your files
end
