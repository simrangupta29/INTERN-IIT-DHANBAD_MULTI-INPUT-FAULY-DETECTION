...
file_path = 'D:\SIMRAN_GUPTA_INTERN\CSV\Leadlag_slowdc\mc_new_1000run.csv';  
...
for i = 1:num_fault_files
    fault_files(i) = sprintf('D://SIMRAN_GUPTA_INTERN//CSV//Leadlag_slowdc//lowcheckfault//low_v%d.csv', i);
end
