clc;
close all;
file_path = 'D:\SIMRAN_GUPTA_INTERN\CSV\Leadlag_slowdc\mc_1000runs.csv';
v = readmatrix(file_path);
time = v(:,1); Vout= v(:,2); VR1=v(:,1002); VR2=v(:,1003);

p= polyfitn([VR1,VR2],Vout,14);
% value = zeros(99,1);
% for index = 1 : 99
%     X1 = time(index);
%     X2 = VR1(index);
