...
file_path = 'D:\SIMRAN_GUPTA_INTERN\CSV\multiplier_slowdc\mc_500runs.csv';
...
for i = 1:num_fault_files
    fault_files(i) = sprintf('D:\\SIMRAN_GUPTA_INTERN\\CSV\\multiplier_slowdc\\multiplefault\\fault_multi%d.csv', i);  % adjust naming scheme as per your files
end
