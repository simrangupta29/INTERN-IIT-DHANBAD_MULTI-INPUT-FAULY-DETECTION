...
file_path = 'D:\SIMRAN_GUPTA_INTERN\CSV\Leadlag_sine\mc_1000runs.csv';
...
for i = 1:num_fault_files
    fault_files(i) = sprintf('D:\\SIMRAN_GUPTA_INTERN\\CSV\\Leadlag_sine\\multiplefault\\fault_multi%d.csv', i);  % adjust naming scheme as per your files
end
